...
Test the circuit by checking that *Digital 2* changes to *true* when you press the button.  (If it changes to *false* when you press the button, you may have the 5V and GND wires reversed)    
![](TestDigital2.PNG)
